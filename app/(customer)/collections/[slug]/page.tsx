...
export default function CollectionDetailPage() {
  ...
  const magazinePages = Array.from({ length: 11 }, (_, i) => 
    `/magazines/${slug}/page-${i + 1}.jpg`
  )
  ...
  return (
    <div className="min-h-screen bg-[#FCFAF7]">
      ...
      <header className="pt-32 pb-16 text-center border-b border-brand-green/5">
        ...
        >
          <span className="text-[10px] tracking-[0.6em] text-brand-gold uppercase font-medium">Collection Edition</span>
      ...
      <section className="py-32 bg-brand-green overflow-hidden">
        ...
        >
          ...
          <p className="text-brand-cream/40 text-[11px] tracking-[0.2em] italic max-w-lg mx-auto leading-relaxed px-4">
            A deeper dive into the craftsmanship and story behind the {mockAlbum.name}.
          </p>
        </motion.div>
      ...
      <section className="py-32 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-gray-400 text-[10px] tracking-[0.5em] uppercase mb-10 italic">Ready to wear?</p>
            <Link 
              href="/products" 
