...
const mockCollections = [
  {
    ...
    slug: 'ramadan-series',
    coverImage: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=1383&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    description: 'Timeless silhouettes for the holy month.'
  },
  {
    name: 'Desert Silk 26',
    slug: 'desert-silk',
    coverImage: 'https://images.unsplash.com/photo-1596783074918-c84cb06531ca?w=800',
    description: 'Flowing fabrics inspired by the dunes.'
  }
]
