      ...
      <div className="container-luxury max-w-3xl">
        ...
        <div className="space-y-12 leading-relaxed text-gray-600">
          <section className="space-y-4">
            ...
            <p>
              Due to the nature of our made-to-order pieces, we do not
              accept returns or exchanges unless the item arrives
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              hours of receiving it with photos of the damage at{' '}
              <a
          ...
          <section className="space-y-4">
            ...
            <p>
              Please refer to our size guide before purchasing. We are
              unable to accept returns due to sizing issues, so please
              measure carefully.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              For any return queries, email us at{' '}
              <a
                href="mailto:mulaanclothing@gmail.com"
                className="text-brand-gold transition-colors hover:underline"
              >
